...
public class ServiceProduct {
	...
	public static void placeRawMaterialOrder(RawMaterialOrder r) {
		com.capgem.dao.DAO.save(r);
	}
	
	public static RawMaterialOrder click() {
		System.out.println("enter the choice");
		System.out.println("1	Raw Material Name");
		System.out.println("1.1 milkshake");
		System.out.println("1.2 choclateshake");
		System.out.println("1.3 coldcoffee");
		...
		Integer choice = 1;
		String Supplier = "123", warehouse = "865";
